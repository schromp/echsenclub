      ...
      { lib, ... }:
      {
        options = {
          ...
          prometheusTargets = lib.mkOption {
            ...
            default = [ ];
            description = "List of Prometheus scrape targets in host:port format (e.g., ['localhost:9090'])";
          };
        };
      };
            ...
            services.opentelemetry-collector = {
              ...
              settings = {
                receivers = {
                  ...
                  prometheus = lib.mkIf (settings.prometheusTargets != [ ]) {
                    config = {
                      scrape_configs = [
                        {
                          job_name = "prometheus";
                          ...
                          static_configs = [
                            {
                              targets = settings.prometheusTargets;
                            }
                          ];
                        }
                      ];
                ...
                service = {
                  ...
                  pipelines = {
                    metrics = {
                      ...
                      ++ lib.optionals (settings.prometheusTargets != [ ]) [ "prometheus" ];
                      processors = [
                        "resourcedetection"
                        "batch"
                      ];
